...
Name: music_cont_out_proxy - Device to forward spikes to remote applications using MUSIC.

Description:
A music_cont_out_proxy is used to send spikes to a remote application that
also uses MUSIC.

The music_cont_out_proxy represents a complete MUSIC event output
