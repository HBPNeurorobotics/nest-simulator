...
nest::music_cont_out_proxy::Parameters_::Parameters_( const Parameters_& op )
...
void
nest::music_cont_out_proxy::Parameters_::set( const DictionaryDatum& d, State_& s )
{
...
//TODO
void
nest::music_cont_out_proxy::handle( SpikeEvent& e )
{
